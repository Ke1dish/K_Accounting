namespace K_Accounting
{
    partial class MainForm
    {
        ...
        {
            TreeNode treeNode13 = new TreeNode("Стартовая (Start)");
            TreeNode treeNode14 = new TreeNode("Счета (Accounts)");
            TreeNode treeNode15 = new TreeNode("Расходы (Expenses)");
            TreeNode treeNode16 = new TreeNode("Доходы (Income)");
            TreeNode treeNode17 = new TreeNode("Категории (Category)");
            TreeNode treeNode18 = new TreeNode("Источники (Source)");
            TreeNode treeNode19 = new TreeNode("Дополнительно (Additionally)");
            TreeNode treeNode20 = new TreeNode("Валюты (Currencies)");
            TreeNode treeNode21 = new TreeNode("Справочники (Directory)", new TreeNode[] { treeNode17, treeNode18, treeNode19, treeNode20 });
            TreeNode treeNode22 = new TreeNode("Отчеты (Reports)");
            TreeNode treeNode23 = new TreeNode("Настройки (Settings)");
            TreeNode treeNode24 = new TreeNode("О программе");
            ...
            treeNode13.Tag = "0";
            treeNode13.Text = "Стартовая (Start)";
            treeNode14.Name = "tnAccounts";
            treeNode14.Tag = "1";
            treeNode14.Text = "Счета (Accounts)";
            treeNode15.Name = "tnExpenses";
            treeNode15.Tag = "2";
            treeNode15.Text = "Расходы (Expenses)";
            treeNode16.Name = "tnIncome";
            treeNode16.Tag = "3";
            treeNode16.Text = "Доходы (Income)";
            treeNode17.Name = "tnCategory";
            treeNode17.Tag = "4";
            treeNode17.Text = "Категории (Category)";
            treeNode18.Name = "tnSource";
            treeNode18.Tag = "5";
            treeNode18.Text = "Источники (Source)";
            treeNode19.Name = "tnAdditionally";
            treeNode19.Tag = "6";
            treeNode19.Text = "Дополнительно (Additionally)";
            treeNode20.Name = "tnCurrencies";
            treeNode20.Tag = "7";
            treeNode20.Text = "Валюты (Currencies)";
            treeNode21.Name = "tnDirectory";
            treeNode21.Tag = "4";
            treeNode21.Text = "Справочники (Directory)";
            treeNode22.Name = "tnReports";
            treeNode22.Tag = "8";
            treeNode22.Text = "Отчеты (Reports)";
            treeNode23.Name = "tnSettings";
            treeNode23.Tag = "9";
            treeNode23.Text = "Настройки (Settings)";
